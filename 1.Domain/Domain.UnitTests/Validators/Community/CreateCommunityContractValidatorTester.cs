...
namespace Domain.Services.Impl.UnitTests.Validators.Community
{
    public class CreateCommunityContractValidatorTester
    {
        ...
        {
            _validator.ShouldHaveValidationErrorFor(CommunityContract => CommunityContract.Name, (string) null, "Create");
        }

        [Fact(DisplayName = "Verify that throws error when Name string is empty")]
        public void Should_Have_Error_When_Name_Is_Empty()
        {
            _validator.ShouldHaveValidationErrorFor(CommunityContract => CommunityContract.Name, String.Empty, "Create");
        }
        ...
        {
            _validator.ShouldHaveValidationErrorFor(CommunityContract => CommunityContract.Description, (string) null, "Create");
        }
    }
}
