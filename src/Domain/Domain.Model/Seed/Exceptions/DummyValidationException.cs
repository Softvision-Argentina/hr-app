// <copyright file="DummyValidationException.cs" company="Softvision">
...
namespace Domain.Model.Seed.Exceptions
{
    ...
    public class CreateContractInvalidException : BusinessValidationException
    {
        ...
        public CreateContractInvalidException(List<KeyValuePair<string, string>> messages)
            : base(messages)
        {
        }
    }
    ...
    public class UpdateContractInvalidException : BusinessValidationException
    {
        ...
        public UpdateContractInvalidException(List<KeyValuePair<string, string>> messages)
            : base(messages)
        {
        }
    }
