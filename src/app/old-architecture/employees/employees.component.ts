...
import { EmployeeAux } from '@shared/models/employee-aux.model';
...
export class EmployeesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.employeeForm = this.fb.group({
      ...
      phoneNumber: [null, [Validators.required, Validators.pattern(/^\+?[1-9]\d{9,11}$/), Validators.minLength(10), Validators.maxLength(12)]],
