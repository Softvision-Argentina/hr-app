...
namespace ApiServer.UnitTests.Controllers
{
    ...
    {
        private DaysOffController controller;
        private Mock<ILog<DaysOffController>> mockLog;
        private Mock<IMapper> mockMapper;
        private Mock<IDaysOffService> mockService;

        public DaysOffControllerTest()
        {
            mockLog = new Mock<ILog<DaysOffController>>();
            mockMapper = new Mock<IMapper>();
            mockService = new Mock<IDaysOffService>();
            controller = new DaysOffController(mockService.Object, mockLog.Object, mockMapper.Object);
        }
        ...
        public void Should_Get_AllDaysOff()
        {
            ...
            mockService.Setup(_ => _.List()).Returns(new[] { new ReadedDaysOffContract() });
            mockMapper.Setup(_ => _.Map<List<ReadedDaysOffViewModel>>(It.IsAny<IEnumerable<ReadedDaysOffContract>>())).Returns(expectedValue);
            ...
            mockMapper.Verify(_ => _.Map<List<ReadedDaysOffViewModel>>(It.IsAny<IEnumerable<ReadedDaysOffContract>>()), Times.Once);
        }
        ...
        public void Should_Get_DaysOffById_WhenDataIsValid()
        {
            ...
            mockService.Setup(_ => _.Read(It.IsAny<int>())).Returns(new ReadedDaysOffContract());
            mockMapper.Setup(_ => _.Map<ReadedDaysOffViewModel>(It.IsAny<ReadedDaysOffContract>())).Returns(expectedValue);

            var result = controller.Get(dayOffId);
            ...
            mockMapper.Verify(_ => _.Map<ReadedDaysOffViewModel>(It.IsAny<ReadedDaysOffContract>()), Times.Once);
        }
        ...
        public void Should_Get_DaysOffById_WhenDataIsInvalid()
        {
            ...
            mockService.Verify(_ => _.Read(It.IsAny<int>()), Times.Once);
            mockMapper.Verify(_ => _.Map<ReadedDaysOffViewModel>(It.IsAny<ReadedDaysOffContract>()), Times.Never);
        }
        ...
        public void Should_GetByDni_WhenDataIsValid()
        {
            ...
            mockService.Setup(_ => _.ReadByDni(It.IsAny<int>())).Returns(new[] { new ReadedDaysOffContract() });
            mockMapper.Setup(_ => _.Map<List<ReadedDaysOffViewModel>>(It.IsAny<IEnumerable<ReadedDaysOffContract>>())).Returns(expectedValue);

            var result = controller.GetByDni(userIdentificationNumber);
            ...
            Assert.Equal(expectedValueAsJson, resultDataAsJson);
            mockService.Verify(_ => _.ReadByDni(It.IsAny<int>()), Times.Once);
            mockMapper.Verify(_ => _.Map<List<ReadedDaysOffViewModel>>(It.IsAny<IEnumerable<ReadedDaysOffContract>>()), Times.Once);
        }
        ...
        public void Should_GetByDni_WhenDataIsInvalid()
        {
            ...
            mockMapper.Setup(_ => _.Map<List<ReadedDaysOffContract>>(It.IsAny<List<DaysOff>>())).Returns((List<ReadedDaysOffContract>)null);
            ...
            Assert.Equal(expectedValue, (result as NotFoundObjectResult).Value);
            mockService.Verify(_ => _.ReadByDni(It.IsAny<int>()), Times.Once);
            mockMapper.Verify(_ => _.Map<List<ReadedDaysOffViewModel>>(It.IsAny<IEnumerable<ReadedDaysOffContract>>()), Times.Never);
        }
        ...
        public void Should_Post_DayOff()
        {
            ...
            mockMapper.Setup(_ => _.Map<CreateDaysOffContract>(It.IsAny<CreateDaysOffViewModel>())).Returns(new CreateDaysOffContract());
            mockMapper.Setup(_ => _.Map<CreatedDaysOffViewModel>(It.IsAny<CreatedDaysOffContract>())).Returns(expectedValue);
            mockService.Setup(_ => _.Create(It.IsAny<CreateDaysOffContract>())).Returns(new CreatedDaysOffContract());

            var result = controller.Post(dayOffVM);
            ...
            mockService.Verify(_ => _.Create(It.IsAny<CreateDaysOffContract>()), Times.Once);
            mockMapper.Verify(_ => _.Map<CreatedDaysOffViewModel>(It.IsAny<CreatedDaysOffContract>()), Times.Once);
        }
        ...
        public void Should_Put_DayOff()
        {
            ...
            mockMapper.Setup(_ => _.Map<UpdateDaysOffContract>(It.IsAny<UpdateDaysOffViewModel>())).Returns(new UpdateDaysOffContract());
            mockService.Setup(_ => _.Update(It.IsAny<UpdateDaysOffContract>()));

            var result = controller.Put(dayOffId, dayOffToUpdate);

            Assert.NotNull(result);
            Assert.IsType<AcceptedResult>(result);
            Assert.Equal(expectedValue.ToQueryString(), (result as AcceptedResult).Value.ToQueryString());
            mockService.Verify(_ => _.Update(It.IsAny<UpdateDaysOffContract>()), Times.Once);
            mockMapper.Verify(_ => _.Map<UpdateDaysOffContract>(It.IsAny<UpdateDaysOffViewModel>()), Times.Once);
        }
        ...
        public void Should_Delete_DayOff()
        {
            ...
            var result = controller.Delete(dayOffId);
