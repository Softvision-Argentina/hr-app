...
namespace Domain.Services.Repositories.EF
{
    public class SeedMigrator : Migrator<DataBaseContext>
    {
        ...
        private static void SeedDummy(DataBaseContext context)
        {
            ...
            var user20 = new User { FirstName = "Tomas", LastName = "Reisenman", Username = "tomas.reisenman@softvision.com", Role = Roles.TechnicalInterviewer, Token = "", Password = "03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4" };
