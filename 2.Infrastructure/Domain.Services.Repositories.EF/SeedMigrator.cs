...
namespace Domain.Services.Repositories.EF
{
    public class SeedMigrator : Migrator<DataBaseContext>
    {
        ...
        private static void SeedDummy(DataBaseContext context)
        {
            ...
            var user90 = new User { FirstName = "communitymanager", LastName = "communitymanager", Username = "communitymanager@softvision.com", Role = Roles.CommunityManager, Token = "", Password = "03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4",Community=Community4 };
            ...
            var preference23 = new Preference { CasualtiesDashboard = true, ProcessesDashboard = true, CompletedDashboard = true, ProjectionDashboard = true, TimeToFill1Dashboard = true, TimeToFIll2Dashboard = true, SkillsDashboard = true, ProgressDashboard = true, User = user91 };
            ...
            context.Preferences.Add(preference23);
